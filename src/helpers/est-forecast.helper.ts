...
export const transformEstForecast = (data: any[]): EstForecast[] => {
  ...
  return data.map((item) => ({
    ...
    ytdPerformance: item[fieldMapping.ytdPerformance],
    aiRating: toNumber(item[fieldMapping.aiRating]),
    yahooRec: item[fieldMapping.yahooRec],
    priceTarget: item[fieldMapping.priceTarget],
    grok: item.grok,
    gpt: item.gpt,
    ...
    article12h: item[fieldMapping.article12h],
