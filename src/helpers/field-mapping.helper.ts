export const fieldMapping: Record<string, string> = {
  ...
  currentPricePct: 'current_price_pct',
  highestPricePct: 'highest_price_pct',
  highest3DaysPricePct: 'highest_3_days_price_pct',
  lowest3DaysPricePct: 'lowest_3_days_price_pct',
  ...
  epsBeatFreq: 'eps_beat_freq',
  epsBeatFreqPoint: 'eps_beat_freq_point',
  revenueBeatFreq: 'revenue_beat_freq',
  revenueBeatFreqPoint: 'revenue_beat_freq_point',
  ...
  priceAtEarning: 'price_at_earning',
  dateAtEarning: 'date_at_earning',
  priceCurrentEstForecast: 'price_current',
  datePrice: 'date_price',
  percentEstForecast: 'percent',
  ...
  mentionsScore: 'mentions__score',
  psychSentimentScore: 'sentiment__score',
  loveHateScore: 'love_hate__score',
  trustScore: 'trust__score',
  disagreementScore: 'disagreement__score',
  emotionVsFactScore: 'emotion_vs_fact__score',
  shortVsLongTermScore: 'short_vs_long_term__score',
  longShortScore: 'long_short__score',
  longShortForecastScore: 'long_short_forecast__score',
  priceDirectionScore: 'price_direction__score',
  priceForecastScore: 'price_forecast__score',
  marketRiskScore: 'market_risk__score',
  topVsBottomScore: 'top_vs_bottom__score',
  overvaluedVsUndervaluedScore: 'overvalued_vs_undervalued__score',
  analystRatingScore: 'analyst_rating__score',
  dividendsScore: 'dividends__score',
  earningsDirectionScore: 'earnings_direction__score',
  earningsForecastScore: 'earnings_forecast__score',
  accountingSentimentScore: 'accounting_sentiment__score',
  revenueDirectionScore: 'revenue_direction__score',
  revenueForecastScore: 'revenue_forecast__score',
  intangiblesSentimentScore: 'intangibles_sentiment__score',
  productSentimentScore: 'product_sentiment__score',
  laborDisputeScore: 'labor_dispute__score',
  layoffsScore: 'layoffs__score',
  litigationScore: 'litigation__score',
  insiderLongShortScore: 'insider_long_short__score',
  managementSentimentScore: 'management_sentiment__score',
  managementChangeScore: 'management_change__score',
  managementTrustScore: 'management_trust__score',
  priceUpScore: 'price_up__score',
  priceDownScore: 'price_down__score',
  volatilityScore: 'volatility__score',
  debtDefaultScore: 'debt_default__score',
  innovationScore: 'innovation__score',
  accountingNegativeScore: 'accounting_negative__score',
  accountingPositiveScore: 'accounting_positive__score',
  accountingRestatementScore: 'accounting_restatement__score',
  partnershipScore: 'partnership__score',
  mergersScore: 'mergers__score',
  cyberCrimeScore: 'cyber_crime__score',
  futureVsPastScore: 'future_vs_past__score',
  negativeScore: 'negative__score',
  positiveScore: 'positive__score',
  optimismScore: 'optimism__score',
  pessimismScore: 'pessimism__score',
  joyScore: 'joy__score',
  angerScore: 'anger__score',
  fearScore: 'fear__score',
  gloomScore: 'gloom__score',
  stressScore: 'stress__score',
  surpriseScore: 'surprise__score',
  timeUrgencyScore: 'time_urgency__score',
  uncertaintyScore: 'uncertainty__score',
  violenceScore: 'violence__score',
  loveHate: 'love_hate',
  emotionVsFact: 'emotion_vs_fact',
  shortVsLongTerm: 'short_vs_long_term',
  longShort: 'long_short',
  longShortForecast: 'long_short_forecast',
  priceDirection: 'price_direction',
  priceForecast: 'price_forecast',
  marketRisk: 'market_risk',
  topVsBottom: 'top_vs_bottom',
  overvaluedVsUndervalued: 'overvalued_vs_undervalued',
  earningsDirection: 'earnings_direction',
  earningsForecast: 'earnings_forecast',
  accountingSentiment: 'accounting_sentiment',
  revenueDirection: 'revenue_direction',
  intangiblesSentiment: 'intangibles_sentiment',
  productSentiment: 'product_sentiment',
  laborDispute: 'labor_dispute',
  insiderLongShort: 'insider_long_short',
  managementSentiment: 'management_sentiment',
  managementChange: 'management_change',
  managementTrust: 'management_trust',
  priceUp: 'price_up',
  priceDown: 'price_down',
  debtDefault: 'debt_default',
  accountingNegative: 'accounting_negative',
  accountingPositive: 'accounting_positive',
  ...
  hitCount1Pct30m: 'hit_count_1pct_30m',
  winRate1Pct30m: 'win_rate_1pct_30m',
  hitCount2Pct30m: 'hit_count_2pct_30m',
  winRate2Pct30m: 'win_rate_2pct_30m',
  hitCount1Pct60m: 'hit_count_1pct_60m',
  winRate1Pct60m: 'win_rate_1pct_60m',
  hitCount2Pct60m: 'hit_count_2pct_60m',
  winRate2Pct60m: 'win_rate_2pct_60m',
  hitCount1Pct90m: 'hit_count_1pct_90m',
  winRate1Pct90m: 'win_rate_1pct_90m',
  hitCount2Pct90m: 'hit_count_2pct_90m',
  winRate2Pct90m: 'win_rate_2pct_90m',
  articleMin: 'article_min',
  articleAvg: 'article_avg',
