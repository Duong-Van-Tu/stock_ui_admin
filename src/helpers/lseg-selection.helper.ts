export const transformLsegSelection = (data: any[]): LsegSelection[] => {
  ...
  return data.map((item) => ({
    ...
    lsegRanking: item.lseg_ranking,
    lsegRankingSummary: item.lseg_ranking_summary,
    marketPsychSummary: item.market_psych_summary,
    lsegNewsSummary: item.lseg_news_summary,
    sector: item.sector,
