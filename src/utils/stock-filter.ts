...
export const getMarketCapOptions = (t: (key: string) => string) => [
  { label: t('any'), value: '' },
  { label: t('under1B'), value: 'u1000000000' },
  { label: t('under2B'), value: 'u2000000000' },
  { label: t('under5B'), value: 'u5000000000' },
  { label: t('under10B'), value: 'u10000000000' },
  { label: t('under50B'), value: 'u50000000000' },
  { label: t('under100B'), value: 'u100000000000' },
  { label: t('under1T'), value: 'u1000000000000' },

  { label: t('over1B'), value: 'o1000000000' },
  { label: t('over10B'), value: 'o10000000000' },
  { label: t('over50B'), value: 'o50000000000' },
  { label: t('over100B'), value: 'o100000000000' },
  { label: t('over500B'), value: 'o500000000000' },
  { label: t('over1T'), value: 'o1000000000000' },

  { label: t('from1bTo2B'), value: '1000000000to2000000000' },
  { label: t('from2bTo5B'), value: '2000000000to5000000000' },
  { label: t('from5bTo10B'), value: '5000000000to10000000000' },
  { label: t('from10bTo50B'), value: '10000000000to50000000000' },
  { label: t('from50bTo100B'), value: '50000000000to100000000000' },
  { label: t('from100bTo500B'), value: '100000000000to500000000000' },
  { label: t('from500bTo1T'), value: '500000000000to1000000000000' }
];
